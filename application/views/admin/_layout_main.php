    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li class="<?php print $active = ($this->uri->uri_string() == 'admin/dashboard') ? "active" : " "; ?>">
                    <?php echo anchor('admin/dashboard', 'Dashboard'); ?>
                </li>
                <li class="<?php print $active = ($this->uri->uri_string() == 'admin/article') ? "active" : " "; ?>">
                    <?php echo anchor('admin/article', 'Articles'); ?>
                </li>
<!--                <li class="dropdown">
